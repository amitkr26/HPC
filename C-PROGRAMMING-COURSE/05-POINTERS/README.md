...
## Planned lessons (Level 7 in `01-ROADMAP.md`)

1. Address-of `&`, dereference `*`, pointer declaration
2. Pointer arithmetic
3. Arrays and pointers (decay, `arr` == `&arr[0]`)
4. Pointers as function arguments (call by reference)
5. Pointers and strings
6. Array of pointers, pointer to pointer
